                ...
                tabsetPanel(id = "tP", type = "pills",
                  ...
                  tabPanel(textOutput("zeit_t"), icon = icon("bar-chart"), value = "tP2",
                           ...
                           conditionalPanel("input.dataAvailable",
                              ...
                              div(id = "bCols1", style = "background-color: orange", textOutput("uRef")),
                              div(id = "bCols2", style = "background-color: green", textOutput("iRef")),
                              div(id = "bCols3", style = "background-color: red", textOutput("ueRef"))
                           )
                  ...
                  tabPanel(textOutput("gesamt_t"), icon = icon("pie-chart"), value = "tP4",
                           ...
                           fluidRow(column(6, align="center",
                                    ...
                                    column(6, align="center",
                                           numericInput("summaryPlotExpander", textOutput("chPlotSize"), 1,
                  ...
                  tabPanel(textOutput("settings"), icon = icon("sliders"), value = "tP5",
                           ...
                           fluidRow(column(3,
                                    ...
                                    column(3, selectInput("mapTilesSelect", textOutput("SelectMapLayer"), choices = providers),
                                           sliderInput("timezoneSlider", textOutput("timeShiftCSV"),
                                                       min = -12, max = 12, step = 1, value = getTZshift()),
                                           numericInput("plotPointsize", textOutput("spotSize"), 1,
                                                        min = 0, max = 3, step = 0.25),
                                           numericInput("plotTextsize", textOutput("textSize"), 1,
